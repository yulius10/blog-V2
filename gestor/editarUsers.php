      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <?php
            ...
            $tabla = "usuario";
            $columnas = "nom_usu,ape_usu,cor_usu,pas_usu";
            $where = "and cod_usu='$id'";
            $order = "";
            ...
            if($registro = mysqli_fetch_array($resultados)){
              ...
              $apellido = $registro["ape_usu"];
              $correo = $registro["cor_usu"];
              $password = $funciones->decode_get2_base($registro["pas_usu"]);
            }

            include("includes/formEditarUsers.php");
