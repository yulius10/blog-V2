  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <?php
        ...
        $tabla = "blog";
        $columnas = "cod_blo,cod_cat,tit_blo,ent_blo,des_blo,ima_blo";
        $where = "and cod_blo='$id'";
        $order = "";

        $resultados = $funciones->consultarRegistro($tabla,$columnas,$where,$order,$link);

        if($registro = mysqli_fetch_array($resultados)){
          $categoria = $registro["cod_cat"];
          $titulo = $registro["tit_blo"];
          $descripcionPeq = $registro["ent_blo"];
          $descripcion = $registro["des_blo"];
          $ima = "../../blog/images/".$registro["ima_blo"];
          if(!file_exists($ima)){
            $ima = "";
          }
        }
        ...
        include("includes/formEditarBlog.php");
