...
class funciones{
    ...
    public function consultarCount($tabla,$where,$link){
        $sql = "select count(*) as total from $tabla where reg_eli=0 $where";
        if($resultado = mysqli_query($link,$sql)){
            $num = mysqli_num_rows($resultado);
            if($num > 0){
                $arreglo = mysqli_fetch_array($resultado);
    ...
    public function consultarColumna($tabla,$columna,$where,$order,$link){
        $sql = "select $columna from $tabla where reg_eli=0 $where $order";
        if($resultado = mysqli_query($link,$sql)){
            $num = mysqli_num_rows($resultado);
            if($num > 0){
                $arreglo=mysqli_fetch_array($resultado);
    ...
    public function consultarRegistroSql($sql,$link){
        if($resultado = mysqli_query($link,$sql)){
            $num = mysqli_num_rows($resultado);
            if($num > 0){
                //$arreglo=mysqli_fetch_array($resultado);
